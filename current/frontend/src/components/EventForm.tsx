...
class EventFormProps {
  ...
  onPropUpdate: (district: string, model_event: string, matchType: string, predictionEvent:string) => void;
  district: string;
  modelEvent: string;
  matchType: string;
  ...
  constructor(
    onTeamsUpdate: (district: string, model_event: string, matchType: string, teams: Team[]) => void,
    onPropUpdate: (district: string, model_event: string, matchType: string, predictionEvent: string) => void, 
    district: string, modelEvent: string, matchType: string, predictionEvent: string) {
  ...
  return (
    <form onSubmit={handleSubmit} className="event-form">
      <div className="form-group">
        ...
        <input type="text" value={district} onChange={e => onPropUpdate(e.target.value, modelEvent, matchType, predictionEvent)} className="input-field" /><br />
      </div>
      <div className="form-group">
        <label>Model Event:</label>
        <input type="text" value={modelEvent} onChange={e => onPropUpdate(district, e.target.value, matchType, predictionEvent)} className="input-field" /><br />
      </div>
      <div className="form-group">
        <label>Match Type:</label>
        <input type="text" value={matchType} onChange={e => onPropUpdate(district, modelEvent, e.target.value, predictionEvent)} className="input-field" /><br />
      </div>
      <div className="form-group">
