...
parser.add_argument('--year', type=int, default=2023, help='Season to fetch')
...
def fetch_matches(team_key = 'frc492'):
    ...
    result = []
    try:
        events = api_instance.get_team_events_by_year(team_key, 2023, if_modified_since=if_modified_since)
        for e in events:
